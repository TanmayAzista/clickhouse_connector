...
class Ui_ClickhouseDialogBase(object):
    def setupUi(self, ClickhouseDialogBase):
        ...
        ClickhouseDialogBase.resize(393, 907)
        self.displaybutton = QtWidgets.QPushButton(ClickhouseDialogBase)
        self.displaybutton.setGeometry(QtCore.QRect(300, 866, 88, 27))
        ...
        self.gridsettingslabel = QtWidgets.QLabel(ClickhouseDialogBase)
        self.gridsettingslabel.setGeometry(QtCore.QRect(10, 800, 291, 19))
        self.gridsettingslabel.setObjectName("gridsettingslabel")
        self.gridrowsbox = QtWidgets.QSpinBox(ClickhouseDialogBase)
        self.gridrowsbox.setGeometry(QtCore.QRect(10, 825, 123, 27))
        self.gridrowsbox.setMinimum(1)
        self.gridrowsbox.setMaximum(200)
        self.gridrowsbox.setObjectName("gridrowsbox")
        self.gridcolsbox = QtWidgets.QSpinBox(ClickhouseDialogBase)
        self.gridcolsbox.setGeometry(QtCore.QRect(139, 825, 123, 27))
        self.gridcolsbox.setMinimum(1)
        self.gridcolsbox.setMaximum(200)
        self.gridcolsbox.setObjectName("gridcolsbox")
        self.pointspercellbox = QtWidgets.QSpinBox(ClickhouseDialogBase)
        self.pointspercellbox.setGeometry(QtCore.QRect(268, 825, 123, 27))
        self.pointspercellbox.setMinimum(1)
        self.pointspercellbox.setMaximum(100000)
        self.pointspercellbox.setObjectName("pointspercellbox")
        self.clearbutton = QtWidgets.QPushButton(ClickhouseDialogBase)
        self.clearbutton.setGeometry(QtCore.QRect(10, 866, 88, 27))
        ...
        self.gridsettingslabel.raise_()
        self.gridrowsbox.raise_()
        self.gridcolsbox.raise_()
        self.pointspercellbox.raise_()
        ...
        ClickhouseDialogBase.setTabOrder(self.querybox, self.gridrowsbox)
        ClickhouseDialogBase.setTabOrder(self.gridrowsbox, self.gridcolsbox)
        ClickhouseDialogBase.setTabOrder(self.gridcolsbox, self.pointspercellbox)
        ClickhouseDialogBase.setTabOrder(self.pointspercellbox, self.clearbutton)
    ...
    def retranslateUi(self, ClickhouseDialogBase):
        ...
        self.gridsettingslabel.setText(_translate("ClickhouseDialogBase", "Grid Settings"))
        self.gridrowsbox.setPrefix(_translate("ClickhouseDialogBase", "Rows: "))
        self.gridcolsbox.setPrefix(_translate("ClickhouseDialogBase", "Cols: "))
        self.pointspercellbox.setPrefix(_translate("ClickhouseDialogBase", "Pts/Cell: "))
